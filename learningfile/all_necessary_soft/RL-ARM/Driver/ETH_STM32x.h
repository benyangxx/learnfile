...
extern unsigned char G_ucEthLinkStatus;
...
#define DP83848C_DEF_ADR    0x0000        /* Default PHY device address        */
#define DP83848C_ID         0x20005C90  /* PHY Identifier                    */
#define LAN8720AI_ID        0XC0000007
...
//#define ETH_MTU         258      /* Ethernet Frame Max Transfer Unit        */


//typedef struct {
//  unsigned char   Flag;//0x01代表数据,0x02,0x04
//  unsigned char   EthDataLen;//数据长度
//  unsigned char   Eth_Rx_Buff[256];//接收缓存
//} Eth_RX_Desc;
